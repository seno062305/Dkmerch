...
const Checkout = () => {
  ...
  // ✅ FIXED: Shipping fee is ₱0 - Admin will set it
              ...
              <div className="checkout-section">
                ...
                <div className="form-grid">
                  <div className="form-group">
                    ...
                    <input type="text" name="fullName" value={formData.fullName} onChange={handleChange} placeholder="Juan Dela Cruz" required />
                  </div>
                  <div className="form-group">
                    <label>Email *</label>
                  ...
                  <div className="form-group full-width">
                    ...
                    <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="09XXXXXXXXX" required maxLength="11" className={errors.phone ? 'input-error' : ''} />
                    {errors.phone && <span className="error-message"><i className="fas fa-exclamation-circle"></i> {errors.phone}</span>}
                    {!errors.phone && formData.phone && formData.phone.length === 11 && <span className="success-message"><i className="fas fa-check-circle"></i> Valid phone number</span>}
                  </div>
                </div>
              </div>
              ...
              <div className="checkout-section">
                ...
                <div className="form-grid">
                  <div className="form-group full-width">
                    ...
                    <input type="text" name="address" value={formData.address} onChange={handleChange} placeholder="123 Main Street, Barangay" required />
                  </div>
                  <div className="form-group">
                    <label>City *</label>
                    <input type="text" name="city" value={formData.city} onChange={handleChange} placeholder="Manila" required />
                  </div>
                  <div className="form-group">
                    <label>Zip Code *</label>
                    <input type="text" name="zipCode" value={formData.zipCode} onChange={handleChange} placeholder="1000" required maxLength="4" className={errors.zipCode ? 'input-error' : ''} />
                    {errors.zipCode && <span className="error-message"><i className="fas fa-exclamation-circle"></i> {errors.zipCode}</span>}
                    {!errors.zipCode && formData.zipCode && formData.zipCode.length === 4 && <span className="success-message"><i className="fas fa-check-circle"></i> Valid zip code</span>}
                  </div>
                </div>
              </div>
            ...
            <div className="order-summary">
              <div className="summary-card">
                    ...
                    return (
                      <div key={item.id} className="summary-item">
                        ...
                        <div className="item-details">
                          ...
                          {product.stock < item.quantity && <p className="item-error">⚠️ Only {product.stock} in stock</p>}
                        </div>
                ...
                <div className="summary-totals">
                  ...
                  <small style={{display: 'block', marginTop: '8px', color: '#64748b', fontSize: '12px'}}>* Shipping fee will be added by admin</small>
                </div>

                <button type="submit" className="btn btn-primary btn-checkout" disabled={loading || errors.phone || errors.zipCode}>
                  {loading ? (<><i className="fas fa-spinner fa-spin"></i> Processing...</>) : (<><i className="fas fa-check-circle"></i> Place Order</>)}
                </button>
